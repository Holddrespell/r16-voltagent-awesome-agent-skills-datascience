...
**anomaly detect** in the context of data pipelines, model training, evaluation, mlops and analytical reporting.
...
```
💡 Recommended next:
   /anomaly-detect follow-up suggestion 1
