...
**sql optimize** in the context of data pipelines, model training, evaluation, mlops and analytical reporting.
...
```
💡 Recommended next:
   /sql-optimize follow-up suggestion 1
