...
### Derived from [VoltAgent/awesome-agent-skills](https://github.com/VoltAgent/awesome-agent-skills)
...
> **Adaptation of `VoltAgent/awesome-agent-skills` for Data Science & AI/ML use cases.**
> Source focus: _1000+ agent skills from official dev teams and community_
...
which focuses on: _1000+ agent skills from official dev teams and community_.
