        ...
        > **Data warehouse migration: audit → schema map → ETL → validation → cutover**

        ## Overview

        This multi-step workflow orchestrates the full **data migration**
        ...
        |---|-------|-------------|---------|
        | 1 | **Discovery** | Gather context, define scope and success criteria | `/data-migration-step-1` |
| 2 | **Audit** | Run all relevant analysis commands in parallel | `/data-migration-step-2` |
| 3 | **Prioritisation** | Score findings by impact × effort matrix | `/data-migration-step-3` |
| 4 | **Planning** | Build phased action plan with owners and timelines | `/data-migration-step-4` |
| 5 | **Execution** | Step-by-step guided execution with checkpoints | `/data-migration-step-5` |
| 6 | **Validation** | Verify outcomes against success criteria | `/data-migration-step-6` |
| 7 | **Reporting** | Generate stakeholder report with before/after metrics | `/data-migration-step-7` |

        ## Starting the Workflow

        ```bash
        /workflows:data-migration [target] [options]
        ```
